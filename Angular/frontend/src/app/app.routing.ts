...
const routes: Routes = [
  ...
  {
    path: "explorer-mobile-onlinedevices/:team_name",
    component: ExplorerOnlineDevicesComponent,
  },
  {
    path: "explorer-mobile-teams-files/:team_name",
    component: ExplorerTeamsFilesComponent,
  },
  {
    path: "explorer-mobile-teams-calendar/:team_name",
    component: ExplorerTeamsCalendarComponent,
  },
  {
    path: "explorer-mobile-team-conversations/:team_name",
    component: ConversationsComponent,
  },
  {
    path: "explorer-mobile-team-conversation/:team_name/:conversationID",
    component: ExplorerTeamConversationComponent,
  },
  {
    path: "explorer-mobile-contact-chat/:contact",
    component: ExplorerContactChatComponent,
  },
